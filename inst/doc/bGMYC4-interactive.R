...
# 
# # 🌐 Interactive visualization / Интерактивная визуализация
# # EN: Displays in RStudio Viewer by default. Add save_html to export.
# # RU: По умолчанию открывается в Viewer RStudio. Укажите save_html для экспорта.
# plot.interactive.probmat(
#   x = prob_mat,
#   tree = tree_consensus,
#   palette = "green",          # "green", "viridis", "RdYlBu", "classic"
#   tree_width = 0.25,          # Доля ширины под дерево (0–1)
#   save_html = "figures/interactive_heatmap.html"  # NULL = только Viewer
# )
# 
# # EN: Open the .html file in any browser to zoom, pan, and hover for exact probabilities.
# # RU: Откройте .html файл в браузере для масштабирования, перемещения и просмотра точных вероятностей при наведении.
# 
